...
#GUI Variables
$FormTitleText = "Диск тазалоочу Джим Тайлер (PowerShellEngineer.com)"
$SelectDiskLabelText = "Диск тандоо:"
$FreeSpaceLabelText = "Бош орун (гигабайт): "
$TotalSpaceLabelText = "Жалпы мейкиндик (гигабайт): "
$JunkFoundLabelText = "таштанды табылды (гигабайт):"
$CleanDiskBtnText = "Дискти тазалоо *Файлдарды жок кылуу*"
$SpaceCleanedLabelText = "Тазаланган мейкиндик (гигабайт): "
$LogFileLabelText = "Лог файл табылды: $abcdefg"
$CreditLabelText = "Джим Тайлер жазган сценарий - PowerShellEngineer.com"
$LogFileLocatedText = "Лог файлы табылды"
$AnalyzingDriveText = "Драйверлерди талдоо..."
$BrowsersAreRunningText = "Браузерлер иштеп жатат... Колдонуучуга кабарлаңыз..."
$PleaseCloseBrowsersText = "Сураныч, бардык веб-браузерлерди жаап, кайра аракет кылыңыз."
$CleaningDriveText = "Драйвды тазалоо..."
